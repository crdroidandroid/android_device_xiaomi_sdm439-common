...
DEVICE_PACKAGE_OVERLAYS += $(LOCAL_PATH)/overlays/overlay-crdroid

PRODUCT_ENFORCE_RRO_TARGETS := *
PRODUCT_ENFORCE_RRO_EXCLUDED_OVERLAYS += $(LOCAL_PATH)/overlays/overlay-system/packages/apps/CarrierConfig
...
# Whitelisted app
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/permissions/privapp-permissions-huaqin.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/privapp-permissions-huaqin.xml
